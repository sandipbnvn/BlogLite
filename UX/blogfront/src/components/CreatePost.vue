<template>
  <div class="contatiner">
    <div class="createpost" style="margin-top:40px;">
      <div class="wrapper">
        <div class="logo">
        ...
        <small class="text-muted">Create New Post</small>

        <form class="p-3 mt-3" enctype="multipart/form-data" @submit.prevent="createpost">
          ...
          <div class="form-field d-flex align-items-center">
            <input ref="fileInput" type="file" name="file" accept="image/*" class="image-input" @input="pickFile" v-on:change="handleFileUpload">
            <!-- <button class="btn mt-3" @click="$refs.fileInput.click()">Pick Image</button> -->
          </div>
          <button type="submit" class="btn mt-3" style="background-color:#539d8b ;">{{ submitButton }}</button>
        </form>
